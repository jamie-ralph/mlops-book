# Networking in Kubernetes (in progress) {.unnumbered}

I recently discovered [this article](https://learnk8s.io/kubernetes-network-packets#tracing-pod-to-pod-communication-on-different-nodes) which provides a more comprehensive view of what's happening in K8s networking - I'll be cleaning up the notes below to make things more concise. 
