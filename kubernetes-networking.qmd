...
* [Services, Load Balancing, Networking](https://kubernetes.io/docs/concepts/services-networking/) from the official Kubernetes docs gives a nice overview of K8s networking API and requirements.  
...
* This article on [different service types](https://kodekloud.com/blog/clusterip-nodeport-loadbalancer/) goes into detail about the different service types available in Kubernetes
