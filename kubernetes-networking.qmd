...
I recently discovered [this article](https://learnk8s.io/kubernetes-network-packets) which provides a more comprehensive view of what's happening in K8s networking - I'll be cleaning up the notes below to make things more concise. 
