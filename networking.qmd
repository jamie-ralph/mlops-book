...
* A service mesh is a piece of infrastructure that makes communication between Kubernetes microservices more secure and trackable. There are different service meshes available, one of which is **istio**. [This video](https://istio.io/latest/about/service-mesh/) from Tech with Nana discusses how istio works and what problems it solves.
